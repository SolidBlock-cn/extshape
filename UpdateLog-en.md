...
The update that only applies to older version, fixing the issue that the pressure plates and buttons of some blocks like wool may cause the server to crash (issue #80).
