...
public class ExtShapeBlockusItemTagProvider extends ExtShapeItemTagProvider {
  public ExtShapeBlockusItemTagProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> completableFuture, ExtShapeBlockTagProvider blockTagProvider) {
