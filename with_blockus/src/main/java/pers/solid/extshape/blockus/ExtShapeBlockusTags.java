...
public final class ExtShapeBlockusTags {
  ...
  static BlockTagPreparation ofBlockAndItem(@NotNull Identifier identifier) {
  ...
  static BlockTagPreparation ofBlockAndItem(@NotNull TagKey<Block> blockTag, @NotNull TagKey<Item> itemTag) {
  ...
  static ItemTagPreparation ofItemOnly(@NotNull TagKey<Item> tag) {
