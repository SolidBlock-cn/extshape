...
public final class ExtShapeBlockusBlocks {
  ...
  static {
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHISELED_MUD_BRICKS, block -> create(block).addExtraTag(BlockTags.PICKAXE_MINEABLE)
        ...
        .setFenceCraftingIngredient(Items.MUD).build());
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_SCULK, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.SCULK_BLOCKS)
        .setFenceCraftingIngredient(Items.SCULK)
        .build());
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_BLACKSTONE_TILES, bsswTypes -> buildStoneBlocksWithoutButton(create(bsswTypes).addExtraTag(BlockusBlockTags.BLACKSTONE_BLOCKS)));
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SMALL_OBSIDIAN_BRICKS, bsswTypes -> buildStoneBlocksWithoutButton(create(bsswTypes).addExtraTag(BlockusBlockTags.OBSIDIAN).setButtonType(ButtonType.HARD)));
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.OBSIDIAN_CIRCULAR_PAVING, block -> buildCircularPavingBlock(FACTORY.createEmpty(block).addExtraTag(BlockusBlockTags.OBSIDIAN).setButtonType(ButtonType.HARD)));
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.GLOWING_OBSIDIAN, block -> buildStoneBlocksWithButton(create(block).addExtraTag(BlockusBlockTags.OBSIDIAN).setButtonType(ButtonType.HARD)));
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.QUARTZ_TILES, bsswTypes -> buildStoneBlocksWithoutButton(create(bsswTypes).addExtraTag(BlockusBlockTags.QUARTZ_BLOCKS).setFenceCraftingIngredient(Items.QUARTZ)));
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.QUARTZ_CIRCULAR_PAVING, block -> buildCircularPavingBlock(FACTORY.createEmpty(block).addExtraTag(BlockusBlockTags.QUARTZ_BLOCKS).setFenceCraftingIngredient(Items.QUARTZ)));
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.BLAZE_BRICKS, bsswTypes -> create(bsswTypes).setFenceCraftingIngredient(Items.BLAZE_ROD).addExtraTag(BlockusBlockTags.BLAZE_BRICKS).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.BLAZE_LANTERN, block -> create(block).setFenceCraftingIngredient(Items.BLAZE_ROD).build());

    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_RED_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HERRINGBONE_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HERRINGBONE_RED_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.NETHER_TILES, block -> create(block).setFenceCraftingIngredient(Items.NETHER_BRICK).addExtraTag(BlockTags.PICKAXE_MINEABLE).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHARRED_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_CHARRED_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.TEAL_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_TEAL_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HERRINGBONE_TEAL_NETHER_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.NETHER_BRICKS).setFenceCraftingIngredient(Items.NETHER_BRICK).without(BlockShape.BUTTON).build());

    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHISELED_PRISMARINE, block -> create(block).addExtraTag(BlockusBlockTags.PRISMARINE_BLOCKS).setFenceCraftingIngredient(Items.PRISMARINE_SHARD).without(BlockShape.BUTTON, BlockShape.FENCE, BlockShape.FENCE_GATE).build());
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHISELED_DARK_PRISMARINE, block -> create(block).addExtraTag(BlockusBlockTags.PRISMARINE_BLOCKS).setFenceCraftingIngredient(Items.PRISMARINE_SHARD).without(BlockShape.BUTTON, BlockShape.FENCE, BlockShape.FENCE_GATE).build());

    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.LARGE_BRICKS, bsswTypes -> create(bsswTypes).addExtraTag(BlockusBlockTags.BRICKS_BLOCKS).setFenceCraftingIngredient(Items.BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HERRINGBONE_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.BRICKS_BLOCKS).setFenceCraftingIngredient(Items.BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SOAKED_BRICKS, bsswTypes -> create(bsswTypes).addExtraTag(BlockusBlockTags.BRICKS_BLOCKS).setFenceCraftingIngredient(Items.BRICK).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HERRINGBONE_SOAKED_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.BRICKS_BLOCKS).setFenceCraftingIngredient(Items.BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHARRED_BRICKS, bsswTypes -> create(bsswTypes).addExtraTag(BlockusBlockTags.BRICKS_BLOCKS).setFenceCraftingIngredient(Items.BRICK).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HERRINGBONE_CHARRED_BRICKS, block -> create(block).addExtraTag(BlockusBlockTags.BRICKS_BLOCKS).setFenceCraftingIngredient(Items.BRICK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SANDY_BRICKS, bsswTypes -> create(bsswTypes).setFenceCraftingIngredient(Items.BRICK).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HERRINGBONE_SANDY_BRICKS, block -> create(block).setFenceCraftingIngredient(Items.BRICK).without(BlockShape.BUTTON).build());

    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.ROUGH_SANDSTONE, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.SANDSTONE).setFenceCraftingIngredient(Items.SAND).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SANDSTONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.SANDSTONE).setFenceCraftingIngredient(Items.SAND).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SMALL_SANDSTONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.SANDSTONE).setFenceCraftingIngredient(Items.SAND).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.ROUGH_RED_SANDSTONE, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.RED_SANDSTONE).setFenceCraftingIngredient(Items.RED_SAND).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.RED_SANDSTONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.RED_SANDSTONE).setFenceCraftingIngredient(Items.RED_SAND).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SMALL_RED_SANDSTONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.RED_SANDSTONE).setFenceCraftingIngredient(Items.RED_SAND).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SOUL_SANDSTONE, bsswTypes -> FACTORY.createConstructionOnly(bsswTypes.block).addExtraTag(BlockusBlockTags.SOUL_SANDSTONE).setFenceCraftingIngredient(Items.SOUL_SAND).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.ROUGH_SOUL_SANDSTONE, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.SOUL_SANDSTONE).setFenceCraftingIngredient(Items.SOUL_SAND).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SOUL_SANDSTONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.SOUL_SANDSTONE).setFenceCraftingIngredient(Items.SOUL_SAND).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SMALL_SOUL_SANDSTONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.SOUL_SANDSTONE).setFenceCraftingIngredient(Items.SOUL_SAND).without(BlockShape.BUTTON).build());

    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SMOOTH_SOUL_SANDSTONE, bssTypes -> create(bssTypes).setFenceCraftingIngredient(Items.SOUL_SAND).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CUT_SOUL_SANDSTONE, bssTypes -> create(bssTypes).setFenceCraftingIngredient(Items.SOUL_SAND).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHISELED_SOUL_SANDSTONE, bssTypes -> create(bssTypes).setFenceCraftingIngredient(Items.SOUL_SAND).without(BlockShape.BUTTON, BlockShape.FENCE, BlockShape.FENCE_GATE).build());

    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.RAINBOW_BLOCK, block -> create(block).addExtraTag(BlockusBlockTags.RAINBOW_BLOCKS).setFenceCraftingIngredient(BlockusItems.RAINBOW_PETAL).setPillar().build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.RAINBOW_BRICKS, bsswTypes -> create(bsswTypes).addExtraTag(BlockusBlockTags.RAINBOW_BLOCKS).setFenceCraftingIngredient(BlockusItems.RAINBOW_PETAL).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.RAINBOW_GLOWSTONE, block -> create(block).setFenceCraftingIngredient(BlockusItems.RAINBOW_PETAL).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HONEYCOMB_BRICKS, bsswTypes -> create(bsswTypes).addExtraTag(BlockusBlockTags.HONEYCOMB_BLOCKS).setFenceCraftingIngredient(Items.HONEYCOMB).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.PURPUR_BRICKS, bsswTypes -> create(bsswTypes).addExtraTag(BlockusBlockTags.PURPUR_BLOCKS).setFenceCraftingIngredient(Items.PURPUR_BLOCK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SMALL_PURPUR_BRICKS, bsswTypes -> create(bsswTypes).addExtraTag(BlockusBlockTags.PURPUR_BLOCKS).setFenceCraftingIngredient(Items.PURPUR_BLOCK).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_PURPUR, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.PURPUR_BLOCKS).setFenceCraftingIngredient(Items.PURPUR_BLOCK).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHISELED_PURPUR, block -> create(block).addExtraTag(BlockusBlockTags.PURPUR_BLOCKS).setFenceCraftingIngredient(Items.PURPUR_BLOCK).without(BlockShape.BUTTON, BlockShape.FENCE, BlockShape.FENCE_GATE).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.PURPUR_SQUARES, block -> create(block).addExtraTag(BlockusBlockTags.PURPUR_BLOCKS).setFenceCraftingIngredient(Items.PURPUR_BLOCK).without(BlockShape.BUTTON).build());

    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.PHANTOM_PURPUR_BRICKS, bsswTypes -> create(bsswTypes).setFenceCraftingIngredient(Items.PHANTOM_MEMBRANE).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SMALL_PHANTOM_PURPUR_BRICKS, bsswTypes -> create(bsswTypes).setFenceCraftingIngredient(Items.PHANTOM_MEMBRANE).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.PHANTOM_PURPUR_BLOCK, bssTypes -> create(bssTypes).setFenceCraftingIngredient(Items.PHANTOM_MEMBRANE).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_PHANTOM_PURPUR, bssTypes -> create(bssTypes).setFenceCraftingIngredient(Items.PHANTOM_MEMBRANE).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHISELED_PHANTOM_PURPUR, block -> create(block).setFenceCraftingIngredient(Items.PHANTOM_MEMBRANE).without(BlockShape.BUTTON, BlockShape.FENCE, BlockShape.FENCE_GATE).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.PHANTOM_PURPUR_SQUARES, block -> create(block).setFenceCraftingIngredient(Items.PHANTOM_MEMBRANE).without(BlockShape.BUTTON).build());

    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.POLISHED_END_STONE, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.END_STONE_BLOCKS).setFenceCraftingIngredient(Items.END_STONE_BRICKS).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SMALL_END_STONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.END_STONE_BLOCKS).setFenceCraftingIngredient(Items.END_STONE_BRICKS).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHISELED_END_STONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.END_STONE_BLOCKS).setFenceCraftingIngredient(Items.END_STONE_BRICKS).without(BlockShape.BUTTON, BlockShape.FENCE, BlockShape.FENCE_GATE).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.HERRINGBONE_END_STONE_BRICKS, bssTypes -> create(bssTypes).addExtraTag(BlockusBlockTags.END_STONE_BLOCKS).setFenceCraftingIngredient(Items.END_STONE_BRICKS).without(BlockShape.BUTTON).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.END_TILES, bssTypes -> create(bssTypes).setFenceCraftingIngredient(Items.END_STONE_BRICKS).addExtraTag(BlockTags.PICKAXE_MINEABLE).without(BlockShape.BUTTON).build());
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.WHITE_OAK_WOOD, block -> FACTORY.createAllShapes(block).setPrimaryTagForShape(logTags).setButtonType(ButtonType.WOODEN)
        .setPillar().addPostBuildConsumer(logFlammable).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.STRIPPED_WHITE_OAK_WOOD, block -> FACTORY.createAllShapes(block).setPrimaryTagForShape(logTags).setButtonType(ButtonType.WOODEN).setPillar().addPostBuildConsumer(logFlammable).build());
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.WHITE_OAK, woodTypesF -> create(woodTypesF).setPrimaryTagForShape(woodenTags).setButtonType(ButtonType.WOODEN).addPostBuildConsumer(plankFlammable).addPostBuildConsumer(plankFuel).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.BAMBOO, woodTypesF -> create(woodTypesF).setPrimaryTagForShape(woodenTags).setButtonType(ButtonType.WOODEN).setFenceCraftingIngredient(Items.BAMBOO).addPostBuildConsumer(plankFlammable).addPostBuildConsumer(plankFuel).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHARRED, woodTypesFP -> create(woodTypesFP).setPrimaryTagForShape(woodenTags).addExtraTag(ItemTags.NON_FLAMMABLE_WOOD).setButtonType(ButtonType.WOODEN).build());
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHORUS_BLOCK, block -> create(block).addExtraTag(BlockTags.HOE_MINEABLE).addExtraTag(addWallToUnmineableTag).setFenceCraftingIngredient(Items.CHORUS_PLANT).setPillar().build());
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SHINGLES, block -> create(block).addExtraTag(BlockusBlockTags.SHINGLES).setFenceCraftingIngredient(Items.FLINT).build());
    for (var supplier : BlockusBlockCollections.TINTED_SHRINGLES) {
      ExtShapeBlockus.tryConsume(supplier, bssTypes -> create(bssTypes).setFenceCraftingIngredient(Items.FLINT).setRecipeGroup(blockShape -> "shingles_" + blockShape.asString()).build());
    }
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.CHARCOAL_BLOCK, block -> create(block).setFenceCraftingIngredient(Items.CHARCOAL).addExtraTag(BlockTags.INFINIBURN_OVERWORLD).addExtraTag(BlockTags.PICKAXE_MINEABLE).addPostBuildConsumer((blockShape, blockBuilder) -> FuelRegistry.INSTANCE.add(blockBuilder.instance, (int) (blockShape.logicalCompleteness * 16000))).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.SUGAR_BLOCK, block -> create(block).setFenceCraftingIngredient(Items.SUGAR).addExtraTag(BlockTags.SHOVEL_MINEABLE).addExtraTag(addWallToUnmineableTag).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.ENDER_BLOCK, block -> create(block).setFenceCraftingIngredient(Items.ENDER_PEARL).addExtraTag(BlockTags.PICKAXE_MINEABLE).addExtraTag(BlockTags.NEEDS_STONE_TOOL).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.ROTTEN_FLESH_BLOCK, block -> create(block).setFenceCraftingIngredient(Items.ROTTEN_FLESH).addExtraTag(BlockTags.HOE_MINEABLE).addExtraTag(addWallToUnmineableTag).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.MEMBRANE_BLOCK, block -> create(block).setFenceCraftingIngredient(Items.PHANTOM_MEMBRANE).addExtraTag(addWallToUnmineableTag).build());
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.NETHER_STAR_BLOCK, block -> FACTORY.createAllShapes(block).withoutRedstone().setFenceCraftingIngredient(Items.NETHER_STAR).addExtraTag(BlockTags.PICKAXE_MINEABLE).addExtraTag(BlockTags.NEEDS_IRON_TOOL).addExtraTag(BlockTags.DRAGON_IMMUNE).withExtension(BlockExtension.builder().setSteppedOnCallback((world, pos, state, entity) -> {
      ...
      builder.setItemSettings(new FabricItemSettings().rarity(Rarity.RARE).group(Blockus.BLOCKUS_BUILDING_BLOCKS));
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.STARS_BLOCK, block -> create(block).setFenceCraftingIngredient(Items.COAL).addExtraTag(BlockTags.PICKAXE_MINEABLE).build());
  }
