...
public final class ExtShapeBlockusBlocks {
  ...
  static {
    ...
    create(BlockusBlocks.RAINBOW_GLOWSTONE)
        .setFenceSettings(new FenceSettings(BlockusItems.RAINBOW_PETAL, ExtShapeBlockTypes.GLOWSTONE_WOOD_TYPE))
    ...
    for (var woolTypes : BlockusBlockCollections.PATTERNED_WOOLS) {
