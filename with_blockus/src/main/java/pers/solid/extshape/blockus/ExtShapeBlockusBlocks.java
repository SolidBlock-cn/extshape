...
public final class ExtShapeBlockusBlocks {
  ...
  static {
    ...
    ExtShapeBlockus.tryConsume(() -> BlockusBlocks.BAMBOO, woodTypesF -> create(woodTypesF).setPrimaryTagForShape(woodenTags).setButtonType(ButtonType.BAMBOO).setCommonFenceSettings(Items.BAMBOO).addPostBuildConsumer(plankFlammable).addPostBuildConsumer(plankFuel).build());
