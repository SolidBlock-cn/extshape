...
public final class ExtShapeBlockusBlocks {
  ...
  static {
    ...
    create(BlockusBlocks.POLISHED_SCULK).addExtraTag(BlockusBlockTags.SCULK_BLOCKS)
        .setFenceSettings(new FenceSettings(Items.SCULK_VEIN))
    ...
    create(BlockusBlocks.CRIMSON_WART_BRICKS).addExtraTag(BlockTags.PICKAXE_MINEABLE)
        .setFenceSettings(new FenceSettings(Items.NETHER_WART))
    ...
    create(BlockusBlocks.BAMBOO).setPrimaryTagForShape(ExtShapeTags.SHAPE_TO_WOODEN_TAG).setActivationSettings(ActivationSettings.BAMBOO).setFenceSettings(FenceSettings.BAMBOO_BLOCK).addPostBuildConsumer(plankFlammable).addPostBuildConsumer(plankFuel).build();
