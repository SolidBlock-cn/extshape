...
public final class ExtShapeBlockusBlocks {
  ...
  static {
    ...
    create(BlockusBlocks.BAMBOO).setPrimaryTagForShape(woodenTags).setButtonType(ButtonType.BAMBOO).setCommonFenceSettings(Items.BAMBOO).addPostBuildConsumer(plankFlammable).addPostBuildConsumer(plankFuel).build();
