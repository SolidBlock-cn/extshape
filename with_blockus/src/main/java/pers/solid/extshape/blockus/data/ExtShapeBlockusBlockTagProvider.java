...
public class ExtShapeBlockusBlockTagProvider extends ExtShapeBlockTagProvider {
  ...
  protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
    ...
    for (BSSWBundle bundle : BlockusBlockCollections.WOODEN_MOSAICS) {
    ...
    addForShapes(BlockusBlockTags.ALL_PATTERNED_WOOLS, Iterables.transform(Iterables.concat(BlockusBlockCollections.PATTERNED_WOOLS, BlockusBlockCollections.GINGHAM_WOOLS), input -> input.block));
    addForShapes(ExtShapeTags.WOOLEN_BLOCKS, Iterables.transform(Iterables.concat(BlockusBlockCollections.PATTERNED_WOOLS, BlockusBlockCollections.GINGHAM_WOOLS), input -> input.block));
