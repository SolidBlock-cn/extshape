...
public final class BlockusBlockCollections {
  ...
  public static final ImmutableList<Supplier<Block>> HERRINGBONE_PLANKS = ImmutableList.of(
      () -> BlockusBlocks.HERRINGBONE_OAK_PLANKS,
      () -> BlockusBlocks.HERRINGBONE_SPRUCE_PLANKS,
      () -> BlockusBlocks.HERRINGBONE_BIRCH_PLANKS,
  ...
  public static final ImmutableList<Supplier<Block>> SMALL_LOGS = ImmutableList.of(
  ...
  public static final ImmutableList<Supplier<BSSWTypes>> STAINED_STONE_BRICKS = ImmutableList.of(
      ...
      () -> BlockusBlocks.LIGHT_BLUE_STONE_BRICKS,
      () -> BlockusBlocks.YELLOW_STONE_BRICKS,
      () -> BlockusBlocks.LIME_STONE_BRICKS,
      () -> BlockusBlocks.PINK_STONE_BRICKS,
      () -> BlockusBlocks.GRAY_STONE_BRICKS,
      () -> BlockusBlocks.CYAN_STONE_BRICKS,
      () -> BlockusBlocks.PURPLE_STONE_BRICKS,
      () -> BlockusBlocks.BLUE_STONE_BRICKS,
      () -> BlockusBlocks.BROWN_STONE_BRICKS,
      () -> BlockusBlocks.GREEN_STONE_BRICKS,
  ...
  public static final ImmutableList<Supplier<ConcreteTypes>> CONCRETE_BRICKS = ImmutableList.of(
      ...
      () -> BlockusBlocks.BLACK_CONCRETE_BRICKS,
      () -> BlockusBlocks.BROWN_CONCRETE_BRICKS,
      () -> BlockusBlocks.RED_CONCRETE_BRICKS,
      () -> BlockusBlocks.ORANGE_CONCRETE_BRICKS,
      () -> BlockusBlocks.YELLOW_CONCRETE_BRICKS,
      () -> BlockusBlocks.LIME_CONCRETE_BRICKS,
      () -> BlockusBlocks.GREEN_CONCRETE_BRICKS,
      () -> BlockusBlocks.CYAN_CONCRETE_BRICKS,
      () -> BlockusBlocks.LIGHT_BLUE_CONCRETE_BRICKS,
      () -> BlockusBlocks.BLUE_CONCRETE_BRICKS,
      () -> BlockusBlocks.PURPLE_CONCRETE_BRICKS,
  ...
  public static final ImmutableList<Supplier<BSSTypes>> TINTED_SHINGLES = ImmutableList.of(
      ...
      () -> BlockusBlocks.LIGHT_BLUE_SHINGLES,
      () -> BlockusBlocks.YELLOW_SHINGLES,
      () -> BlockusBlocks.LIME_SHINGLES,
      () -> BlockusBlocks.PINK_SHINGLES,
      () -> BlockusBlocks.LIGHT_GRAY_SHINGLES,
      () -> BlockusBlocks.GRAY_SHINGLES,
      () -> BlockusBlocks.CYAN_SHINGLES,
      () -> BlockusBlocks.PURPLE_SHINGLES,
      () -> BlockusBlocks.BLUE_SHINGLES,
      () -> BlockusBlocks.BROWN_SHINGLES,
      () -> BlockusBlocks.GREEN_SHINGLES,
  ...
  public static final ImmutableList<Supplier<Block>> PATTERNED_WOOLS = ImmutableList.of(
      ...
      () -> BlockusBlocks.LIGHT_BLUE_PATTERNED_WOOL,
      () -> BlockusBlocks.YELLOW_PATTERNED_WOOL,
      () -> BlockusBlocks.LIME_PATTERNED_WOOL,
      () -> BlockusBlocks.PINK_PATTERNED_WOOL,
      () -> BlockusBlocks.GRAY_PATTERNED_WOOL,
      () -> BlockusBlocks.LIGHT_GRAY_PATTERNED_WOOL,
      () -> BlockusBlocks.CYAN_PATTERNED_WOOL,
      () -> BlockusBlocks.PURPLE_PATTERNED_WOOL,
      () -> BlockusBlocks.BLUE_PATTERNED_WOOL,
      () -> BlockusBlocks.BROWN_PATTERNED_WOOL,
      () -> BlockusBlocks.GREEN_PATTERNED_WOOL,
      () -> BlockusBlocks.RED_PATTERNED_WOOL,
      () -> BlockusBlocks.BLACK_PATTERNED_WOOL
  );

  public static final ImmutableList<Supplier<Block>> COLORED_TILES = ImmutableList.of(
      () -> BlockusBlocks.WHITE_COLORED_TILES,
      () -> BlockusBlocks.ORANGE_COLORED_TILES,
      () -> BlockusBlocks.MAGENTA_COLORED_TILES,
      () -> BlockusBlocks.LIGHT_BLUE_COLORED_TILES,
      () -> BlockusBlocks.YELLOW_COLORED_TILES,
      () -> BlockusBlocks.LIME_COLORED_TILES,
      () -> BlockusBlocks.PINK_COLORED_TILES,
      () -> BlockusBlocks.GRAY_COLORED_TILES,
      () -> BlockusBlocks.LIGHT_GRAY_COLORED_TILES,
      () -> BlockusBlocks.CYAN_COLORED_TILES,
      () -> BlockusBlocks.PURPLE_COLORED_TILES,
      () -> BlockusBlocks.BLUE_COLORED_TILES,
      () -> BlockusBlocks.BROWN_COLORED_TILES,
      () -> BlockusBlocks.GREEN_COLORED_TILES,
      () -> BlockusBlocks.RED_COLORED_TILES,
      () -> BlockusBlocks.BLACK_COLORED_TILES
  );

  public static final ImmutableList<Supplier<Block>> GLAZED_TERRACOTTA_PILLARS = ImmutableList.of(
      () -> BlockusBlocks.WHITE_GLAZED_TERRACOTTA_PILLAR,
