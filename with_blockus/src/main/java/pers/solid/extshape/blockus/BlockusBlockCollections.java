...
public final class BlockusBlockCollections {
  ...
  public static final ImmutableList<Block> PATTERNED_WOOLS = ImmutableList.of(
  ...
  public static final ImmutableList<Block> GLAZED_TERRACOTTA_PILLARS = ImmutableList.of(
