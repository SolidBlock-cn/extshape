...
- 优化物品组规则的实现方式，不再在每次重建创造模式物品栏时重建物品组规则，且可以更早地使用。现在模组中的物品能正确地在 JustEnoughItems 模组的物品列表中显示。
- 为 1.21.10 以下版本跟进了 3.1.5 中的更新。
- 重新加入了在 Minecraft 1.19.3 时移除的“专用物品组”的功能。现在有 5 个专用物品组：木制与竹制方块、彩色方块、石质方块、矿物方块、其他方块。现在专用物品组的开启与关闭需要重启游戏才能生效。
  - 彩色方块专用物品组中，方块颜色的排序方式与原版物品组中相同。
- 增加了两个配置项：木制与竹制方块专用物品组排序与彩色方块专用物品组排序。
  - 木制与竹制方块专用物品组的排序方式可以设置为：“相同物种不同形式的在一起”（默认）与“相同形式不同物种的在一起”。“物种”指不同类型的树木，如橡木、白桦木等，而“形式”则指该木头被加工成的形式，如木头（菌核）、原木（菌柄）、木板等。竹块视为原木形式，竹板视为木板形式，无对应木头形式。例如，设置为“相同物种不同形式的在一起”时，橡木、去皮橡木、橡木木板等方块的各形式在一起，而设置为“相同形式不同物种的在一起”，则橡木、白桦木等各类的木头方块在一起，而橡木木板、白桦木板等各类木板在一起。
  - 彩色方块专用物品组的排序方式可以设置为“相同颜色不同形状的在一起”和“相同形状不同颜色的在一起”。例如，设置为“相同颜色不同形状的在一起”时，白色羊毛及其楼梯、台阶等在一起，淡灰色羊毛及其楼梯、台阶等在一起，而设置为“相同形状不同颜色的在一起”时，白、淡灰等各颜色羊毛的基础方块在一起，各颜色羊毛的楼梯在一起，各颜色羊毛的台阶在一起。
...
- 模组更新至 1.21.11。更新内容请参见 3.1.0 及更早版本的更新日志。
