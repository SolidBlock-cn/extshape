...
public class Mappings {
    ...
    static {
        ...
        mappingOfTopTexture.put(Blocks.SANDSTONE, new Identifier("minecraft", "blocks/sandstone_top"));
        mappingOfBottomTexture.put(Blocks.SANDSTONE, new Identifier("minecraft", "block/sandstone_bottom"));
        mappingOfTopTexture.put(Blocks.RED_SANDSTONE, new Identifier("minecraft", "blocks/red_sandstone_top"));
