...
public class ExtShapeRRPScreen extends Screen {
  ...
  protected void init() {
    ...
    }, (button, matrices, mouseX, mouseY) -> renderOrderedTooltip(matrices, textRenderer.wrapLines(new TranslatableText("options.extshape.rrp.regenClientResources.description"), 200), mouseX, mouseY)));
    ...
    }, (button, matrices, mouseX, mouseY) -> renderOrderedTooltip(matrices, textRenderer.wrapLines(new TranslatableText("options.extshape.rrp.regenServerData.description"), 200), mouseX, mouseY)));
    ...
    }, (button, matrices, mouseX, mouseY) -> renderOrderedTooltip(matrices, textRenderer.wrapLines(new TranslatableText("options.extshape.rrp.exportClientResources.description"), 200), mouseX, mouseY)));
    ...
    }, (button, matrices, mouseX, mouseY) -> renderOrderedTooltip(matrices, textRenderer.wrapLines(new TranslatableText("options.extshape.rrp.exportServerData.description"), 200), mouseX, mouseY)));
  ...
  public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
    ...
    MultilineText.create(textRenderer, new TranslatableText("options.extshape.rrp.info", ScreenTexts.BACK).formatted(Formatting.YELLOW), width - 40).drawCenterWithShadow(matrices, width / 2, 170);
  }
