...
public class StairsBuilder extends AbstractBlockBuilder<StairsBlock> {
    ...
    public void writeBlockStates(RuntimeResourcePack pack) {
        ...
        pack.addAsset(new Identifier(identifier.getNamespace(), "blockstates/" + identifier.getPath() + ".json"), String.format(BLOCK_STATES_FORMAT, blockIdentifier(identifier)).getBytes());
    }
