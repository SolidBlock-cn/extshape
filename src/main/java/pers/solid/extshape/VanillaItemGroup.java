...
public final class VanillaItemGroup {
  private static final Map<RegistryKey<ItemGroup>, Multimap<Item, Item>> APPENDING_RULES = new Object2ObjectLinkedOpenHashMap<>();
  private static final Map<RegistryKey<ItemGroup>, Multimap<Item, Item>> PREPENDING_RULES = new Object2ObjectLinkedOpenHashMap<>();
