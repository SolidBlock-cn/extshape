...
public class ExtShapeVerticalQuarterPieceBlock extends VerticalQuarterPieceBlock implements ExtShapeVariantBlockInterface {
  ...
  public ExtShapeVerticalQuarterPieceBlock(@NotNull Block baseBlock, Properties settings) {
    super(settings);
  ...
  public MutableComponent getName() {
    return Component.translatable("block.extshape.?_vertical_quarter_piece", this.getNamePrefix());
  }
