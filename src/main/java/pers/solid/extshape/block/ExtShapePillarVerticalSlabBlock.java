...
public class ExtShapePillarVerticalSlabBlock extends ExtShapeVerticalSlabBlock {
  ...
  public void writeBlockModel(RuntimeResourcePack pack) {
    ...
    if (isLog) {
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal"), blockModel.withParent(ExtShape.id("block/vertical_slab_column_horizontal")));
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal_top"), blockModel.withParent(ExtShape.id("block/vertical_slab_column_horizontal_top")));
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal_unordered"), blockModel.withParent(ExtShape.id("block/vertical_slab_column_horizontal_unordered")));
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal_unordered_top"), blockModel.withParent(ExtShape.id("block/vertical_slab_column_horizontal_unordered_top")));
    } else {
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal"), blockModel.withParent(ExtShape.id("block/vertical_slab_column")));
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal_top"), blockModel.withParent(ExtShape.id("block/vertical_slab_column_top")));
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal_unordered"), blockModel.withParent(ExtShape.id("block/vertical_slab_column_unordered")));
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal_unordered_top"), blockModel.withParent(ExtShape.id("block/vertical_slab_column_unordered_top")));
    }
  }
