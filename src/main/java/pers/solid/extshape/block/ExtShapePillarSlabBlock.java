...
public class ExtShapePillarSlabBlock extends ExtShapeSlabBlock {
  ...
  public void writeBlockModel(RuntimeResourcePack pack) {
    ...
    if (hasHorizontalColumn) {
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal"), blockModel.withParent(Identifier.of(ExtShape.MOD_ID, "block/slab_column_horizontal")));
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal_top"), blockModel.withParent(Identifier.of(ExtShape.MOD_ID, "block/slab_column_horizontal_top")));
    } else {
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal"), blockModel.withParent(Identifier.of(ExtShape.MOD_ID, "block/slab_column")));
      pack.addModel(getBlockModelId().brrp_suffixed("_horizontal_top"), blockModel.withParent(Identifier.of(ExtShape.MOD_ID, "block/slab_column_top")));
    }
  }
