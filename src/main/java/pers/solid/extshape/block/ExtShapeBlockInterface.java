...
public interface ExtShapeBlockInterface extends BlockResourceGenerator, IForgeBlock {
  ...
  default SingleItemRecipeJsonBuilder simpleStoneCuttingRecipe(int resultCount) {
    ...
    if (baseBlock == null) {
      ...
      return SingleItemRecipeJsonBuilder.createStonecutting(Ingredient.ofItems(baseBlock), (ItemConvertible) this, resultCount).criterion("has_base_block", RecipeProvider.conditionsFromItem(baseBlock));
    }
  }
