...
public abstract class TagPreparation<E> extends AbstractCollection<E> {
  ...
  public boolean add(E e) {
    if (FabricLoader.getInstance().isDevelopmentEnvironment() && entryList.contains(e)) {
  ...
  public boolean addTag(TagPreparation<E> es) {
    ...
    if (FabricLoader.getInstance().isDevelopmentEnvironment() && tagList.contains(es)) {
  ...
  public abstract Tag<E> toVanillaTag();

  public abstract IdentifiedTag toBRRPDataGenerationTag();
  ...
  public IdentifiedTag generateTag() {
    final IdentifiedTag jTag = toBRRPDataGenerationTag();
    for (E e : entryList) {
