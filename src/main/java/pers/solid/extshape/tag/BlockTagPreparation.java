...
public class BlockTagPreparation extends TagPreparation<Block> {
  ...
  @Override
  public TagKey<Block> toVanillaTag() {
    return TagKey.of(ForgeRegistries.Keys.BLOCKS, identifier);
  }
   ...
   * @return 物品标签对象。
   */
  public TagKey<Item> toVanillaItemTag() {
    return TagKey.of(ForgeRegistries.Keys.ITEMS, identifier);
  }
}
