...
public final class ExtShapeTags {
  ...
  public static final TagKey<Block> CONCRETE_STAIRS = ofBlockAndItem("concrete_stairs", STAIRS);
  public static final TagKey<Block> TERRACOTTA_STAIRS = ofBlockAndItem("terracotta_stairs", STAIRS);
  ...
  public static final TagKey<Block> CONCRETE_SLABS = ofBlockAndItem("concrete_slabs", SLABS);
  public static final TagKey<Block> TERRACOTTA_SLABS = ofBlockAndItem("terracotta_slabs", SLABS);
  ...
  public static final TagKey<Block> CONCRETE_FENCES = ofBlockAndItem("concrete_fences", FENCES);
  public static final TagKey<Block> TERRACOTTA_FENCES = ofBlockAndItem("terracotta_fences", FENCES);
  ...
  /* 栅栏门 */
  public static final TagKey<Block> FENCE_GATES = ofBlockAndItem(BlockTags.FENCE_GATES, ItemTags.FENCE_GATES);
  ...
  public static final TagKey<Block> CONCRETE_FENCE_GATES = ofBlockAndItem("concrete_fence_gates", FENCE_GATES);
  public static final TagKey<Block> TERRACOTTA_FENCE_GATES = ofBlockAndItem("terracotta_fence_gates", FENCE_GATES);
  ...
  public static final TagKey<Block> WOODEN_WALLS = ofBlockAndItem("wooden_walls", WALLS, WOODEN_BLOCKS);
  public static final TagKey<Block> LOG_WALLS = ofBlockAndItem("log_walls", WOODEN_WALLS, LOG_BLOCKS);
  @ApiStatus.AvailableSince("1.5.0")
  public static final TagKey<Block> WOOLEN_WALLS = ofBlockAndItem("woolen_walls", WALLS, WOOLEN_BLOCKS);
  public static final TagKey<Block> CONCRETE_WALLS = ofBlockAndItem("concrete_fence_walls", WALLS);
  public static final TagKey<Block> TERRACOTTA_WALLS = ofBlockAndItem("terracotta_fence_walls", WALLS);
  ...
  public static final TagKey<Block> CONCRETE_BUTTONS = ofBlockAndItem("concrete_buttons", BUTTONS);
  public static final TagKey<Block> TERRACOTTA_BUTTONS = ofBlockAndItem("terracotta_buttons", BUTTONS);
  ...
  /* 压力板 */
  public static final TagKey<Block> PRESSURE_PLATES = ofBlockOnly(BlockTags.PRESSURE_PLATES);  // ItemTags.PRESSURE_PLATES不存在
  ...
  public static final TagKey<Block> CONCRETE_PRESSURE_PLATES = ofBlockAndItem("concrete_pressure_plates", PRESSURE_PLATES);
  public static final TagKey<Block> TERRACOTTA_PRESSURE_PLATES = ofBlockAndItem("terracotta_pressure_plates", PRESSURE_PLATES);
  ...
  public static final TagKey<Block> CONCRETE_VERTICAL_SLABS = ofBlockAndItem("concrete_vertical_slabs", VERTICAL_SLABS);
  public static final TagKey<Block> TERRACOTTA_VERTICAL_SLABS = ofBlockAndItem("terracotta_vertical_slabs", VERTICAL_SLABS);
  ...
  public static final TagKey<Block> CONCRETE_QUARTER_PIECES = ofBlockAndItem("concrete_quarter_pieces", QUARTER_PIECES);
  public static final TagKey<Block> TERRACOTTA_QUARTER_PIECES = ofBlockAndItem("terracotta_quarter_pieces", QUARTER_PIECES);
  ...
  public static final TagKey<Block> CONCRETE_VERTICAL_STAIRS = ofBlockAndItem("concrete_vertical_stairs", VERTICAL_STAIRS);
  public static final TagKey<Block> TERRACOTTA_VERTICAL_STAIRS = ofBlockAndItem("terracotta_vertical_stairs", VERTICAL_STAIRS);
  ...
  public static final TagKey<Block> CONCRETE_VERTICAL_QUARTER_PIECES = ofBlockAndItem("concrete_vertical_quarter_pieces", VERTICAL_QUARTER_PIECES);
  public static final TagKey<Block> TERRACOTTA_VERTICAL_QUARTER_PIECES = ofBlockAndItem("terracotta_vertical_quarter_pieces", VERTICAL_QUARTER_PIECES);
   ...
   * 其他部分
   */
  public static final TagKey<Block> AXE_MINEABLE = ofBlockOnly(BlockTags.AXE_MINEABLE);
  public static final TagKey<Block> HOE_MINEABLE = ofBlockOnly(BlockTags.HOE_MINEABLE);
  public static final TagKey<Block> PICKAXE_MINEABLE = ofBlockOnly(BlockTags.PICKAXE_MINEABLE);
  public static final TagKey<Block> SHOVEL_MINEABLE = ofBlockOnly(BlockTags.SHOVEL_MINEABLE);
  public static final TagKey<Block> SHEARS_MINEABLE = ofBlockOnly(FabricMineableTags.SHEARS_MINEABLE);
  public static final TagKey<Block> OCCLUDES_VIBRATION_SIGNALS = ofBlockOnly(BlockTags.OCCLUDES_VIBRATION_SIGNALS);
  ...
  public static final TagKey<Block> NEEDS_DIAMOND_TOOL = ofBlockOnly(BlockTags.NEEDS_DIAMOND_TOOL);
  public static final TagKey<Block> NEEDS_IRON_TOOL = ofBlockOnly(BlockTags.NEEDS_IRON_TOOL);
  public static final TagKey<Block> NEEDS_STONE_TOOL = ofBlockOnly(BlockTags.NEEDS_STONE_TOOL);
  ...
  private static TagKey<Block> ofBlockOnly(@NotNull TagKey<Block> tag) {
    return tag;
  }
  ...
  @InlineMe(replacement = "tag")
  private static TagKey<Item> ofItemOnly(@NotNull TagKey<Item> tag) {
    return tag;
  }
}