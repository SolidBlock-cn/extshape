...
public final class ExtShapeTags {
  ...
  /* 栅栏门 */
  public static final BlockTagPreparation FENCE_GATES = ofBlockOnly(BlockTags.FENCE_GATES);
  ...
  public static final BlockTagPreparation NON_FLAMMABLE_WOOD = ofBlockAndItem(BlockTags.NON_FLAMMABLE_WOOD, ItemTags.NON_FLAMMABLE_WOOD);
  /**
  ...
  private static BlockTagPreparation ofBlockOnly(@NotNull Tag.Identified<Block> tag) {
    final BlockTagPreparation empty = TagPreparationFactory.BLOCK.ofEmpty(tag);
    TAGS_TO_WRITE.add(empty);
    return empty;
  }

  private static BlockTagPreparation ofBlockAndItem(@NotNull Tag.Identified<Block> blockTag, @NotNull Tag.Identified<Item> itemTag) {
  ...
  private static ItemTagPreparation ofItemOnly(@NotNull Tag.Identified<Item> tag) {
