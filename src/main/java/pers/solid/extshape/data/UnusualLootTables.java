...
public class UnusualLootTables {
   ...
   * 只有带有精准采集附魔时才会掉落的方块。
   */
  public static final LootTableFunction DROPS_DOUBLE_WITH_SILK_TOUCH_OR_NONE = (baseBlock, shape, block, generator) -> dropsDoubleSlabWithSilkTouchOrNone(block, shape == BlockShape.SLAB);
  ...
  private static void registerUnusualLootTables(ImmutableMap.Builder<Block, LootTableFunction> builder) {
    ...
    builder.put(Blocks.GLOWSTONE, (baseBlock, shape, block, generator) -> {
    ...
    builder.put(Blocks.MELON, (baseBlock, shape, block, generator) -> {
      final float shapeVolume = shapeVolume(shape);
    ...
    builder.put(Blocks.SEA_LANTERN, (baseBlock, shape, block, generator) -> {
      final float shapeVolume = shapeVolume(shape);
    ...
    builder.put(Blocks.GILDED_BLACKSTONE, (baseBlock, shape, block, generator) -> {
      final float shapeVolume = shapeVolume(shape);
    ...
    builder.put(Blocks.ICE, DROPS_DOUBLE_WITH_SILK_TOUCH_OR_NONE);
    builder.put(Blocks.BLUE_ICE, DROPS_DOUBLE_WITH_SILK_TOUCH_OR_NONE);
    builder.put(Blocks.PACKED_ICE, DROPS_DOUBLE_WITH_SILK_TOUCH_OR_NONE);
    builder.put(Blocks.SCULK, DROPS_DOUBLE_WITH_SILK_TOUCH_OR_NONE);
  }
  ...
  public interface LootTableFunction {
    LootTable.Builder apply(Block baseBlock, BlockShape shape, Block block, BlockLootTableGenerator generator);
  }
}
