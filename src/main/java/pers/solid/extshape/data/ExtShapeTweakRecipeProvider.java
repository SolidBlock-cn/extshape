...
public class ExtShapeTweakRecipeProvider extends FabricRecipeProvider {
  public ExtShapeTweakRecipeProvider(FabricDataOutput output) {
    super(output);
  }
  ...
  public void generate(Consumer<RecipeJsonProvider> exporter) {
    ...
    Iterable<Pair<Block, Ingredient>> baseAndResource = List.of(
        Pair.of(Blocks.EMERALD_BLOCK, Ingredient.fromTag(ConventionalItemTags.EMERALDS)),
        ...
        Pair.of(Blocks.DIAMOND_BLOCK, Ingredient.fromTag(ConventionalItemTags.DIAMONDS)),
        Pair.of(Blocks.COAL_BLOCK, Ingredient.ofItems(Items.COAL)),
        Pair.of(Blocks.LAPIS_BLOCK, Ingredient.fromTag(ConventionalItemTags.LAPIS)),
