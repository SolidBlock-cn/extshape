...
public class ExtShapeItemTagProvider extends FabricTagProvider.ItemTagProvider {
  ...
  public ExtShapeItemTagProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> completableFuture, ExtShapeBlockTagProvider blockTagProvider) {
