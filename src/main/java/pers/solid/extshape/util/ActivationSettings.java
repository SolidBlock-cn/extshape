...
public record ActivationSettings(BlockSetType blockSetType, int buttonTime, int plateTime, boolean buttonActivatedByProjectile, PressurePlateBlock.ActivationRule activationRule) {
  ...
  public static ActivationSettings soft(BlockSetType blockSetType) {
    return new ActivationSettings(blockSetType, 60, 60, true, PressurePlateBlock.ActivationRule.EVERYTHING);
  }

  public static ActivationSettings softerStone(BlockSetType blockSetType) {
    return new ActivationSettings(blockSetType, 40, 30, false, PressurePlateBlock.ActivationRule.MOBS);
  }
  ...
  public static final ActivationSettings WOOL = new ActivationSettings(ExtShapeBlockTypes.WOOL_BLOCK_SET_TYPE, 50, 50, true, PressurePlateBlock.ActivationRule.EVERYTHING);
  ...
  public static final ActivationSettings CROPS = new ActivationSettings(BlockSetType.OAK, 50, 40, false, PressurePlateBlock.ActivationRule.MOBS);
  public static final ActivationSettings QUARTZ = new ActivationSettings(ExtShapeBlockTypes.QUARTZ_BLOCK_SET_TYPE, 25, 25, false, PressurePlateBlock.ActivationRule.MOBS);
