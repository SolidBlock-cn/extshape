...
//      CHISELED_RED_SANDSTONE,
  ...
  public static final @Unmodifiable ImmutableSet<Block> WOOLS = ImmutableSet.copyOf(WOOL.asList());
  public static final @Unmodifiable ImmutableSet<Block> GLAZED_TERRACOTTA = ImmutableSet.copyOf(Blocks.GLAZED_TERRACOTTA.asList());
  public static final @Unmodifiable ImmutableSet<Block> CONCRETES = ImmutableSet.copyOf(CONCRETE.asList());
  public static final @Unmodifiable ImmutableSet<Block> STAINED_TERRACOTTA = ImmutableSet.copyOf(DYED_TERRACOTTA.asList());
