...
public record FenceSettings(Item secondIngredient, SoundEvent closeSound, SoundEvent openSound) {
  ...
  public FenceSettings(Item secondIngredient, String namespace, String constSoundName) {
    this(secondIngredient, new SoundEvent(new Identifier(namespace, "block." + constSoundName + "_fence_gate.close")), new SoundEvent(new Identifier(namespace, "block." + constSoundName + "_fence_gate.open")));
  }
  ...
  public static final FenceSettings AMETHYST = new FenceSettings(Items.AMETHYST_SHARD, ExtShape.MOD_ID, "amethyst");
  public static final FenceSettings BAMBOO_BLOCK = new FenceSettings(Items.BAMBOO);
  public static final FenceSettings STONE = new FenceSettings(Items.FLINT);
  public static final FenceSettings DIRT = DEFAULT;
  public static final FenceSettings WOOL = new FenceSettings(Items.STRING, ExtShape.MOD_ID, "wool");
  public static final FenceSettings SNOW = new FenceSettings(Items.SNOW, ExtShape.MOD_ID, "snow");
  ...
  public static final FenceSettings WART = new FenceSettings(Items.NETHER_WART, ExtShape.MOD_ID, "wart");
}
