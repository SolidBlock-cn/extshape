...
public record FenceSettings(Item secondIngredient, SoundEvent closeSound, SoundEvent openSound) {
  ...
  public FenceSettings(Item secondIngredient, String namespace, String constSoundName) {
    this(secondIngredient, SoundEvent.of(new Identifier(namespace, "block." + constSoundName + "_fence_gate.close")), SoundEvent.of(new Identifier(namespace, "block." + constSoundName + "_fence_gate.open")));
  }
