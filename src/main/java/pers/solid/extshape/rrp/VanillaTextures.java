...
public class VanillaTextures {
  ...
  public static void registerTextures() {
    ...
    TextureRegistry.register(Blocks.CHERRY_LOG, TextureKey.END, new Identifier(Identifier.DEFAULT_NAMESPACE, "block/cherry_log_top"));
    ...
    TextureRegistry.register(Blocks.CHERRY_WOOD, new Identifier(Identifier.DEFAULT_NAMESPACE, "block/cherry_log"));
    ...
    TextureRegistry.register(Blocks.STRIPPED_CHERRY_LOG, TextureKey.END, new Identifier(Identifier.DEFAULT_NAMESPACE, "block/stripped_cherry_log_top"));
    ...
    TextureRegistry.register(Blocks.STRIPPED_CHERRY_WOOD, new Identifier(Identifier.DEFAULT_NAMESPACE, "block/stripped_cherry_log"));
