...
import pers.solid.extshape.mixin.SingleItemRecipeJsonFactoryAccessor;
    ...
    for (final BlockShape blockShape : BlockShape.values()) {
      ...
      for (final Block uncutBaseBlock : uncutBaseBlocks) {
        ...
        if (recipe != null) {
          ...
          SingleItemRecipeJsonFactoryAccessor accessor = (SingleItemRecipeJsonFactoryAccessor) recipe;
