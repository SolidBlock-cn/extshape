...
public class CrossShapeDataGeneration {
  ...
  protected void writeBlockRotationRecipe(final @NotNull Block from, final @NotNull Block to, @Nullable String suffix, String criterionName) {
    ...
    final ShapelessRecipeJsonFactory recipe = ShapelessRecipeJsonFactory.create(to).input(Ingredient.ofItems(from));
    final String recipeGroup = getRecipeGroup(to);
    recipe.group(StringUtils.isEmpty(recipeGroup) ? recipeGroup : recipeGroup + "_from_rotation").criterion(criterionName, RecipesProvider.conditionsFromItem(from));
  ...
  public void craftSlabToQuarterPiece(final @NotNull Block slab, final @NotNull Block quarterPiece, @Nullable String suffix) {
    ...
    final ShapedRecipeJsonFactory recipe = ShapedRecipeJsonFactory.create(quarterPiece, 6)
        .pattern("###")
        .input('#', slab)
        .group(StringUtils.isEmpty(recipeGroup) ? recipeGroup : recipeGroup + "_from_slab")
        .criterion("has_slab", RecipesProvider.conditionsFromItem(slab));
    pack.addRecipeAndAdvancement(recipeId, recipe);
  }
  ...
  public void craftVerticalSlabToQuarterPiece(final @NotNull Block verticalSlab, final @NotNull Block quarterPiece, @Nullable String suffix) {
    ...
    final ShapedRecipeJsonFactory recipe = ShapedRecipeJsonFactory.create(quarterPiece, 6)
        ...
        .criterion("has_vertical_slab", RecipesProvider.conditionsFromItem(verticalSlab));
    pack.addRecipeAndAdvancement(recipeId, recipe);
  }
  ...
  public void craftVerticalSlabToVerticalQuarterPiece(final @NotNull Block verticalSlab, final @NotNull Block verticalQuarterPiece, @Nullable String suffix) {
    ...
    final ShapedRecipeJsonFactory recipe = ShapedRecipeJsonFactory.create(verticalQuarterPiece)
  ...
  protected void generateSimpleStonecuttingRecipe(
    ...
    final SingleItemRecipeJsonFactory recipe = SingleItemRecipeJsonFactory.createStonecutting(Ingredient.ofItems(ingredient), result, count)
        .group(RecipeGroupRegistry.getRecipeGroup(result))
        .criterion(criterionName, RecipesProvider.conditionsFromItem(ingredient));
    pack.addRecipeAndAdvancement(recipeId, recipe);
  }
  ...
  public void generateCrossShapeData() {
    ...
    for (final BlockShape blockShape : BlockShape.values()) {
      ...
      for (final Block uncutBaseBlock : uncutBaseBlocks) {
        ...
        SingleItemRecipeJsonFactory recipe = ((BlockResourceGenerator) output).getStonecuttingRecipe();
        if (recipe != null) {
          ...
          final SingleItemRecipeJsonFactory secondaryRecipe = SingleItemRecipeJsonFactory.createStonecutting(
              Ingredient.ofItems(uncutBaseBlock),
              accessor.getOutput(),
              accessor.getCount()
          ).criterion("has_" + path, RecipesProvider.conditionsFromItem(uncutBaseBlock));
    ...
    if (quarterPiece != null) {
      ...
      if (stairs != null && shouldStoneCut) {
        ...
        for (final Block uncutBaseBlock : uncutBaseBlocks) {
          ...
          final String name0 = ForgeRegistries.BLOCKS.getKey(uncutStairs).getPath();
      ...
      if (slab != null) {
        ...
        if (shouldStoneCut) {
          ...
          for (final Block uncutBaseBlock : uncutBaseBlocks) {
            ...
            final String name0 = ForgeRegistries.BLOCKS.getKey(uncutSlab).getPath();
      ...
      if (verticalSlab != null) {
        ...
        if (shouldStoneCut) {
          ...
          for (final Block uncutBaseBlock : uncutBaseBlocks) {
            ...
            cutVerticalSlabToQuarterPiece(uncutVerticalSlab, quarterPiece, "_from_" + ForgeRegistries.BLOCKS.getKey(uncutVerticalSlab).getPath() + "_stonecutting");
          }
        }
      }
    }
    ...
    if (verticalQuarterPiece != null) {
      ...
      if (verticalSlab != null) {
        ...
        if (shouldStoneCut) {
          ...
          for (final Block uncutBaseBlock : uncutBaseBlocks) {
            ...
            cutVerticalSlabToVerticalQuarterPiece(uncutVerticalSlab, verticalQuarterPiece, "_from_" + ForgeRegistries.BLOCKS.getKey(uncutVerticalSlab).getPath() + "_stonecutting");
          }
        }
      }
      ...
      if (verticalStairs != null && shouldStoneCut) {
        ...
        for (final Block uncutBaseBlock : uncutBaseBlocks) {
          ...
          cutVerticalStairsToVerticalQuarterPiece(uncutVerticalStairs, verticalQuarterPiece, "_from_" + ForgeRegistries.BLOCKS.getKey(uncutVerticalStairs).getPath() + "_stonecutting");
        }
      }
    }
  }
