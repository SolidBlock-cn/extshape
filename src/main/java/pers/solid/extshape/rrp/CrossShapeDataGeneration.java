      ...
      if (verticalSlab != null) {
        ...
        if (shouldStoneCut) {
          ...
          if (enableCuttingShape) for (final var uncutBaseBlockInfo : uncutBaseBlocks) {
            ...
            cutVerticalSlabToQuarterPiece(uncutVerticalSlab, quarterPiece, "_from_" + Registry.BLOCK.getId(uncutVerticalSlab).getPath() + "_stonecutting", uncutBaseBlockInfo.rightInt());
          }
        }
      }
    }
    ...
    if (verticalQuarterPiece != null) {
      ...
      if (verticalSlab != null) {
        ...
        if (shouldStoneCut) {
          ...
          if (enableCuttingShape) for (final var uncutBaseBlockInfo : uncutBaseBlocks) {
            ...
            cutVerticalSlabToVerticalQuarterPiece(uncutVerticalSlab, verticalQuarterPiece, "_from_" + Registry.BLOCK.getId(uncutVerticalSlab).getPath() + "_stonecutting", uncutBaseBlockInfo.rightInt());
          }
        }
      }
      ...
      if (verticalStairs != null && shouldStoneCut) {
        ...
        if (enableCuttingShape) for (final var uncutBaseBlockInfo : uncutBaseBlocks) {
          ...
          cutVerticalStairsToVerticalQuarterPiece(uncutVerticalStairs, verticalQuarterPiece, "_from_" + Registry.BLOCK.getId(uncutVerticalStairs).getPath() + "_stonecutting", uncutBaseBlockInfo.rightInt());
        }
      }
    }
  }
