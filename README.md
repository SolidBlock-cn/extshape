...
模组目前支持 Minecraft Java 版 1.18.2、1.18.1、1.18、1.17.1、1.17、1.16.5 和 1.16.4，请根据你的游戏版本安装对应的模组（1.18.1 的模组兼容 1.18，1.16.5 的模组兼容 1.16.4），并需要 Fabric API 和 BRRP。此外，通常还需要 Mod Menu（非必须）以打开模组配置界面。
